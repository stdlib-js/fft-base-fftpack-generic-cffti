...
```javascript
cffti = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/fft-base-fftpack-generic-cffti@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var cffti = require( 'path/to/vendor/umd/fft-base-fftpack-generic-cffti/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/fft-base-fftpack-generic-cffti@umd/browser.js"></script>
```
...
#### cffti( N, workspace, strideW, offsetW )
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/fft-base-fftpack-generic-cffti.svg
[npm-url]: https://npmjs.org/package/@stdlib/fft-base-fftpack-generic-cffti

[test-image]: https://github.com/stdlib-js/fft-base-fftpack-generic-cffti/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/fft-base-fftpack-generic-cffti/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/fft-base-fftpack-generic-cffti/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/fft-base-fftpack-generic-cffti?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/fft-base-fftpack-generic-cffti.svg
[dependencies-url]: https://david-dm.org/stdlib-js/fft-base-fftpack-generic-cffti/main
...
[deno-url]: https://github.com/stdlib-js/fft-base-fftpack-generic-cffti/tree/deno
[deno-readme]: https://github.com/stdlib-js/fft-base-fftpack-generic-cffti/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/fft-base-fftpack-generic-cffti/tree/umd
[umd-readme]: https://github.com/stdlib-js/fft-base-fftpack-generic-cffti/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/fft-base-fftpack-generic-cffti/tree/esm
[esm-readme]: https://github.com/stdlib-js/fft-base-fftpack-generic-cffti/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/fft-base-fftpack-generic-cffti/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/fft-base-fftpack-generic-cffti/main/LICENSE
